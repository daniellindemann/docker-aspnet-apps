...
# Usage:
#   ./05-build-image-self-contained-alpine.sh [--no-cache] [--multi-platform]
#
# Parameters:
#   --no-cache
...
#
# Examples:
#   ./05-build-image-self-contained-alpine.sh
#   ./05-build-image-self-contained-alpine.sh --no-cache
#   ./05-build-image-self-contained-alpine.sh --multi-platform
#   ./05-build-image-self-contained-alpine.sh --no-cache --multi-platform
...
dockerfile=Dockerfile.self-contained-alpine
image_names=(
